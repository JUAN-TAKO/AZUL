<template>
    <div class="fenetre-winner-overflow d-flex row m-0 p-0" v-if="this.$store.state.winner === null">
        ...
        <div class="fenetre-winner m-auto row m-0 p-5">
            <div class="col-12">
                <div class=""><h2 class="text-white text-center victoire-titre">Victoire <!--{{ $store.state.winner.name }}-->Joueur 2 !</h2></div>
                <div class=""><h2 class="text-white text-center victoire-score">Score <!--{{ $store.state.winner.name }}-->220</h2></div>
            </div>
            <div class="col-12 row m-0 p-0">
                <div class="col-12 col-md-10 mx-auto row py-2">
                    ...
                    <div class="col-3 mx-auto embed-responsive embed-responsive-1by1 btn-victoire"><div class="embed-responsive-item d-flex flex-column" @click="recommancer()"><p class="text-center text-btn-victoire mb-0 text-break">Sauvegarder</p><img class="w-auto h-auto mx-auto my-1 my-md-2" src="img/sauvegarde.png" alt="image de refresh"></div></div>
                </div>
            </div>
        </div>
    </div>
