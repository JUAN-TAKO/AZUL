...
public class NNModel
{
    ...
    public NNModel(int nb_players)
    {
        ...
        builder.addLayer("L1_center", new DenseLayer.Builder().nIn(40).nOut(center_layer_out).build(), "center");
        ...
        builder.addLayer("prediction", new OutputLayer.Builder().lossFunction(LossFunctions.LossFunction.MSE).nIn(L8_size).nOut(1).build(), "L8_game");
